...
df = pd.DataFrame(data) #DateFrame 객체 생성

# 시각적 강조
st.dataframe(
    df.style
    .highlight_max(subset=["Sales"], color="lightblue")
